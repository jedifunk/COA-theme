...
function jbfj_choosing_setup() {
	 ...
	 * If you're building a theme based on Choosing Our Adventure, use a find and replace
	 * to change 'jbfj-choosing' to the name of your theme in all the template files.
	 */
	...
	add_theme_support( 'custom-background', apply_filters( 'jbfj_choosing_custom_background_args', array(
...
function jbfj_choosing_scripts() {
	...
	wp_enqueue_script( 'jbfj-choosing-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'jbfj-choosing-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
